...
interface MinuteCandleAnalysisRepository : JpaRepository<MinuteCandleAnalysis, MinuteCandleKey> {
    ...
    @Query("select mc from MinuteCandleMacd mc where mc.minuteCandleKey.market = :market and mc.minuteCandleKey.unit = :unit order by mc.minuteCandleKey.timestamp")
